...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: EditorPage(themeMode: _themeMode, onToggleTheme: _toggleTheme),
    );
  }
}
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SettingRow(label: 'Font Family', value: _editorConfig.fontFamily),
              SettingRow(
                label: 'Tab Size',
              ...
              SettingRow(
                label: 'Line Numbers',
                value: _editorConfig.showLineNumbers ? 'Enabled' : 'Disabled',
              ),
              SettingRow(
                label: 'Minimap',
