...
import 'package:flutter_monaco/src/core/file_operations.dart' if (dart.library.html) 'file_operations_stub.dart';
...
import 'package:flutter_monaco/src/platform/platform_detector.dart' if (dart.library.html) '../platform/platform_detector_stub.dart';
import 'package:flutter_monaco/src/platform/platform_webview.dart';
import 'package:flutter_monaco/src/platform/web_webview_controller.dart' if (dart.library.io) '../platform/web_webview_controller_stub.dart';
...
class MonacoController {
  ...
  static Future<MonacoController> create({
    ...
    if (kIsWeb) {
      ...
      await _initializeWebWebView(
        webViewController as WebWebViewController,
        bridge,
        customCss: customCss,
  ...
  static Future<void> _initializeWebWebView(
    ...
    // Generate HTML content for web platform
    final targetDir = 'assets/packages/flutter_monaco/assets/monaco';
    ...
    debugPrint('[MonacoController] Loading HTML for web platform');
  ...
  /// Supported: Web (IFrame), Windows (WebView2), macOS/iOS (WKWebView)
